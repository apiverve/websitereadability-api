# Website Readability Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:websitereadability-api:1.1.12'
}
```
...
```java
import com.apiverve.websitereadability.WebsiteReadabilityAPIClient;
import com.apiverve.websitereadability.APIResponse;
import com.apiverve.websitereadability.APIException;

// Initialize the client
WebsiteReadabilityAPIClient client = new WebsiteReadabilityAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/websitereadability](https://docs.apiverve.com/ref/websitereadability)
...
- **Documentation:** [https://docs.apiverve.com/ref/websitereadability](https://docs.apiverve.com/ref/websitereadability)
- **Issues:** [GitHub Issues](https://github.com/apiverve/websitereadability-api/issues)
