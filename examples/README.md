# Website Readability API - Examples

This folder contains example code for using the Website Readability API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/websitereadability',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/websitereadability");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/websitereadability](https://docs.apiverve.com/ref/websitereadability)
