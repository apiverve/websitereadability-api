...
namespace APIVerve.API.WebsiteReadability
{
    ...
    /// <summary>
    /// Client for the WebsiteReadability API
    /// </summary>
...
#endif
    {
        ...
        public WebsiteReadabilityAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WebsiteReadabilityAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WebsiteReadabilityAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        private void ValidateParams(WebsiteReadabilityQueryOptions options)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(WebsiteReadabilityQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(WebsiteReadabilityQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(WebsiteReadabilityQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(WebsiteReadabilityQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(WebsiteReadabilityQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
