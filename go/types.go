// Package websitereadability provides a Go client for the Website Readability API.
//
// For more information, visit: https://apiverve.com/marketplace/websitereadability?utm_source=go&utm_medium=readme
package websitereadability
...
// Request contains the parameters for the Website Readability API.
//
// Parameters:
//   - url (required): string - The URL of the web page to analyze [format: url]
type Request struct {
...
// ResponseData contains the data returned by the Website Readability API.
type ResponseData struct {
	FleschReadingEase float64 `json:"fleschReadingEase"`
	FleschReadingEaseText string `json:"fleschReadingEaseText"`
	...
	SmogIndex float64 `json:"smogIndex"`
	AutomatedReadabilityIndex float64 `json:"automatedReadabilityIndex"`
	DaleChallReadabilityScore int `json:"daleChallReadabilityScore"`
	DaleChallReadabilityScoreText string `json:"daleChallReadabilityScoreText"`
	Url string `json:"url"`
}
